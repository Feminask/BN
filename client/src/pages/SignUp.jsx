...
>
  <span style={{fontFamily:"Montserrat, sans-serif"}} className="px-2 py-1 bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 rounded-lg text-white ">
    BlogNexus
          ...
          Welcome to BlogNexus! Join our community of passionate writers and readers by creating your account. Share your stories and explore inspiring content. Sign up now to start writing, commenting, and Exploring with like-minded individuals!
